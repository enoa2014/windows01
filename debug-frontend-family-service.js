/**
 * Frontend Family Service Debug Script
 * Create a test HTML file to debug frontend loading
 */
...
<body>
    ...
    await fs.writeFile(path.join(__dirname, 'src/renderer/debug-family-service.html'), debugHTML);
    console.log('✅ 调试文件已创建: src/renderer/debug-family-service.html');
    console.log('请在应用中访问这个页面来调试前端问题');
}

createDebugFile().catch(console.error);